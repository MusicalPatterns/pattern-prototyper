...
import { as, Block, Duration, musicalAs, Tone } from '@musical-patterns/utilities'

const PROTOTYPER_INITIAL_MS_PHYSICALIZATION: Duration = musicalAs.Duration(200)
const PROTOTYPER_INITIAL_HZ_PHYSICALIZATION: Tone = musicalAs.Tone(200)
...
const CHORD_PRESET_MS_PHYSICALIZATION: Duration = musicalAs.Duration(1000)
...
export {
    ...
    CHORD_PRESET_MS_PHYSICALIZATION,
}
