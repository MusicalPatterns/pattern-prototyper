import { Entity, Note, PitchOnly, TimbreNameEnum } from '@musical-patterns/material'
            ...
            sections: [
                {
                    notes: specs[ PrototyperSpec.BLOCK_1 ].map(
                        (blockElement: number): Note => computeNote(as.ContourElement<PitchOnly>([ blockElement ])),
                    ),
                },
            ],
